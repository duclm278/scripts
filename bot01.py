...
def main():
    ...
    try:
        wait.until(EC.visibility_of_element_located(
            (By.XPATH, "/html/body/div[3]/div/div[2]/div[1]/div/form/div[1]/div/div/div[4]/div[2]")))
    except:
        print("Error!")
    driver.find_element(
        By.XPATH, "/html/body/div[3]/div/div[2]/div[1]/div/form/div[1]/div/div/div[4]/div[2]").click()

    try:
        wait.until(EC.visibility_of_element_located(
            (By.CSS_SELECTOR, "option[value='5129919684149249']")))
    except:
        print("Error!")
    driver.find_element(
        By.CSS_SELECTOR, "option[value='5129919684149249']").click()
    ...
    entry = driver.find_element(
        By.XPATH, "/html/body/div[5]/div/div/div[2]/table")
